...
if __name__ ==  "__main__": 
    ...
    for f in os.listdir(root_json):
        ...
        prompt = f"""
            ...
            \n
            LOCATION is the name of the nearest Point of Interest. If there are multiple locations, respond corresponding number of JSON objects.
            \n
            Select the WATER_TYPE that best fits one of these: [{v3}].
            \n
