...
if __name__ ==  "__main__": 
    ...
    for f in os.listdir(root_json):
        ...
        r1_summarize = f"""
            ...
            All data is from the State of California. If there is no latitude and longitude data in the document, use inference to locate the watersource and record the results as "Inferred_Latitude" and "Inferred_Longitude"; do not comment on how the inference was made.
