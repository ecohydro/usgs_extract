...
if __name__ ==  "__main__": 
    ...
    columns = ["ID", "PAGE_NUMBER", "LATITUDE", "LONGITUDE", "WATERSOURCE_NAME", "COUNTY", "DATE_OF_DATA", "RESOLUTION", "WATER_TYPE"]
    ...
    for f in os.listdir(root_json):
        ...
        prompt = f"""
            ...
            \n
            LOCATION is the name of the nearest Point of Interest. If there are multiple LOCATION, respond corresponding number of JSON objects.
            \n
